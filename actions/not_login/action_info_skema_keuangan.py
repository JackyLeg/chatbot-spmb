...
class InfoSkemaKeuangan(Action):
    def name(self) -> Text:
        return "action_info_skema_keuangan"
    ...
    def run(
        ...
        if fetch_peraturan_api(tracker.sender_id, "skema_keuangan"):
            return [SlotSet("return_value", "api_success")]
        return [SlotSet("return_value", "Info Skema Keuangan")]
