...
class InfoJadwalSeleksi(Action):
    def name(self) -> Text:
        return "action_info_jadwal_seleksi"
    ...
    def run(
        ...
        if fetch_peraturan_api(tracker.sender_id, "jadwal_seleksi"):
            return [SlotSet("return_value", "api_success")]
        return [SlotSet("return_value", "Info Jadwal Seleksi")]
