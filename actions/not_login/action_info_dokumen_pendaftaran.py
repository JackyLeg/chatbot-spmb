...
class InfoDokumenPendaftaran(Action):
    def name(self) -> Text:
        return "action_info_dokumen_pendaftaran"
    ...
    def run(
        ...
        if fetch_peraturan_api(tracker.sender_id, "dokumen_pendaftaran"):
            return [SlotSet("return_value", "api_success")]
        return [SlotSet("return_value", "Info Kelengkapan Dokumen Pendaftaran")]
